        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              Your source for the latest tech news and insights. Stay informed with our curated articles.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/science" className="hover:text-white">Science</Link></li>
              <li><Link to="/innovation" className="hover:text-white">Innovation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <a href="https://x.com/marstrx0" className="hover:opacity-80">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#FDB5CE">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/marstrx/" className="hover:opacity-80">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#FDB5CE">
