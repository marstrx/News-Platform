        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-col justify-center items-start gap-5 px-20 py-28">
            <div className="flex items-center gap-10">
              ...
              <p className="text-2xl text-emerald-900 font-mono">
                {user?.name || "-"}
              </p>
            </div>
            <div className="flex items-center gap-10">
            ...
            <button
              ...
              className="bg-[#a43100] rounded text-white p-2 w-full mt-20 font-mono cursor-pointer"
            >
              Edit My Information
            </button>
          </div>
          ...
          <div className="flex flex-col gap-5 px-20 py-28 w-full max-w-md">
            ...
            <div className="flex justify-evenly items-center gap-3">
              <button
                ...
                className="bg-[#a43100] rounded text-white p-2 font-mono cursor-pointer w-full"
              >
                Save
              </button>
              <button
